...
namespace UniRx
{
    ...
    ///     This type parameter is contravariant. That is, you can use either the type you specified or any type that is less
    ///     derived. For more information about covariance and contravariance, see Covariance and Contravariance in Generics.
    /// </typeparam>
    /// <typeparam name="TResult">
    ///     The type of the result returned from the observer's notification handlers.
    ///     This type parameter is covariant. That is, you can use either the type you specified or any type that is more
    ///     derived. For more information about covariance and contravariance, see Covariance and Contravariance in Generics.
    /// </typeparam>
	...
	public abstract class Notification<T> : IEquatable<Notification<T>>
	{
        ...
        /// <summary>
        ///     Determines whether the current Notification&lt;T&gt; object has the same observer message payload as a specified
        ...
        /// <remarks>
        ///     Equality of Notification&lt;T&gt; objects is based on the equality of the observer message payload they represent,
        ///     including the notification Kind and the Value or Exception (if any).
        ///     This means two Notification&lt;T&gt; objects can be equal even though they don't represent the same observer method
        ///     call, but have the same Kind and have equal parameters passed to the observer method.
        ///     In case one wants to determine whether two Notification&lt;T&gt; objects represent the same observer method call,
        ///     use Object.ReferenceEquals identity equality instead.
        /// </remarks>
        ...
        /// <returns>
        ///     true if the first Notification&lt;T&gt; value has the same observer message payload as the second Notification
        ...
        /// <param name="right">The second Notification&lt;T&gt; to compare, or null.</param>
        /// <returns>
        ///     true if the first Notification&lt;T&gt; value has a different observer message payload as the second
        ///     Notification&lt;T&gt; value; otherwise, false.
        /// </returns>
        /// <remarks>
        ///     Equality of Notification&lt;T&gt; objects is based on the equality of the observer message payload they represent,
        ///     including the notification Kind and the Value or Exception (if any).
        ///     This means two Notification&lt;T&gt; objects can be equal even though they don't represent the same observer method
        ///     call, but have the same Kind and have equal parameters passed to the observer method.
        ///     In case one wants to determine whether two Notification&lt;T&gt; objects represent a different observer method
        ///     call, use Object.ReferenceEquals identity equality instead.
        /// </remarks>
        public static bool operator !=(Notification<T> left, Notification<T> right)
		{
			return !(left == right);
    ...
    public static class Notification
	{
        ...
        /// </summary>
        /// <typeparam name="T">
        ///     The type of the elements received by the observer. Upon dematerialization of the notifications into
