...
namespace UniRx
{
    ...
    ///     The timestamp typically represents the time the value was received, using an IScheduler's clock to obtain the
    ///     current time.
    /// </summary>
	...
	public struct Timestamped<T> : IEquatable<Timestamped<T>>
	{
        ...
        /// <summary>
        ///     Determines whether the current Timestamped&lt;T&gt; value has the same Value and Timestamp as a specified
        ///     Timestamped&lt;T&gt; value.
        /// </summary>
        ...
        /// <returns>
        ///     true if the first Timestamped&lt;T&gt; value has the same Value and Timestamp as the second Timestamped&lt;T
        ...
        /// <param name="second">The second Timestamped&lt;T&gt; value to compare.</param>
        /// <returns>
        ///     true if the first Timestamped&lt;T&gt; value has a different Value or Timestamp as the second Timestamped&lt;T
        ///     &gt; value; otherwise, false.
        /// </returns>
        public static bool operator !=(Timestamped<T> first, Timestamped<T> second)
		{
