...
{
    /// <summary>
    ///     Represents a .NET event invocation consisting of the strongly typed object that raised the event and the data that
    ...
    /// <summary>
    ///     Represents a .NET event invocation consisting of the weakly typed object that raised the event and the data that
    ///     was generated by the event.
    /// </summary>
		...
		IEventPattern<TSender, TEventArgs>
	{
        ...
        /// <summary>
        ///     Determines whether the current EventPattern&lt;TSender, TEventArgs&gt; object represents the same event as a
        ///     specified EventPattern&lt;TSender, TEventArgs&gt; object.
        /// </summary>
        ...
        /// <returns>
        ///     true if the specified System.Object is equal to the current EventPattern&lt;TSender, TEventArgs&gt;;
        ///     otherwise, false.
        /// </returns>
		...
		{
			int x = EqualityComparer<TSender>.Default.GetHashCode(Sender);
			int y = EqualityComparer<TEventArgs>.Default.GetHashCode(EventArgs);
			return (x << 5) + (x ^ y);
		}
