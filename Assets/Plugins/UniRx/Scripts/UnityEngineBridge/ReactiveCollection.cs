...
namespace UniRx
{
	...
	{
		[NonSerialized] private Subject<CollectionAddEvent<T>> collectionAdd = null;

		[NonSerialized] private Subject<CollectionMoveEvent<T>> collectionMove = null;

		[NonSerialized] private Subject<CollectionRemoveEvent<T>> collectionRemove = null;

		[NonSerialized] private Subject<CollectionReplaceEvent<T>> collectionReplace = null;

		[NonSerialized] private Subject<Unit> collectionReset = null;


		[NonSerialized] private Subject<int> countChanged = null;
