...
namespace UniRx
{
...
#endif
	{
		...
		[NonSerialized] private Subject<DictionaryAddEvent<TKey, TValue>> dictionaryAdd = null;
		...
		[NonSerialized] private Subject<DictionaryRemoveEvent<TKey, TValue>> dictionaryRemove = null;
		...
		[NonSerialized] private Subject<DictionaryReplaceEvent<TKey, TValue>> dictionaryReplace = null;
