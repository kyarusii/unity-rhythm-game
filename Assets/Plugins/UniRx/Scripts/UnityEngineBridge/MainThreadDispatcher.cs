...
namespace UniRx
{
	public sealed class MainThreadDispatcher : MonoBehaviour
	{
		...
		[ThreadStatic] private static object mainThreadToken;
		...
		private readonly ThreadSafeQueueWorker queueWorker = new ThreadSafeQueueWorker();
		...
		{
			MainThreadDispatcher[] dispatchers = FindObjectsOfType<MainThreadDispatcher>();
		...
		private class EditorThreadDispatcher
		{
			...
			private readonly ThreadSafeQueueWorker editorQueueWorker = new ThreadSafeQueueWorker();
...
#pragma warning restore CS0618
					...
					if (type == typeof(WaitForSeconds))
					{
						...
						FieldInfo accessor = typeof(WaitForSeconds).GetField("m_Seconds",
